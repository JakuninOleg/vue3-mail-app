<template>
  <div class="email-display">
    <div>
      <button @click="toggleArchive">{{email.archived ? 'Move to Inbox' : 'Archive'}} (e)</button>
      <button @click="toggleRead">{{email.read ? 'Mark Unread' : 'Mark Read'}} (r)</button>
    ...
    <div>
      <em>From {{email.from}} on {{format(new Date(email.sentAt), 'do MMM yy')}}</em>
    </div>
